    ...
    slides: [
      {
        ...
        data: {
          sprints: [
            ...
            { sprintNumber: 268, paidUsers: 575, totalPaidQTD: 3387 },
            { sprintNumber: 269, paidUsers: 586, totalPaidQTD: 3973 },
            { sprintNumber: 270, paidUsers: 659, totalPaidQTD: 4632 },
            { sprintNumber: 271, paidUsers: 600, totalPaidQTD: 5314 },
          ],
          quarters: [
            { quarter: "Q1", total: 5278, average: 468 },
            { quarter: "Q2", total: 6247, average: 475 },
            { quarter: "Q3", total: 5314, average: 570 },
          ],
        },
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 268, blog: 2, infographics: 0, kb: 0, videos: 0, guestPosts: 0, hidden: false },
            { sprint: 269, blog: 3, infographics: 0, kb: 0, videos: 0, guestPosts: 0, hidden: false },
            { sprint: 270, blog: 2, infographics: 0, kb: 0, videos: 1, guestPosts: 1, hidden: false },
            { sprint: 271, blog: 3, infographics: 1, kb: 0, videos: 0, guestPosts: 1, hidden: false },
            { sprint: 272, blog: 1, infographics: 0, kb: 0, videos: 0, guestPosts: 0, hidden: false },
          ],
        },
      },
      {
        ...
        data: {
          ...
          positionChanges: {
            ...
            rows: [
              ...
              { sprint: 268, pos1_2: 18, pos3_10: 35, hidden: false },
            ],
          },
      ...
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 267, total: 45, social: 7, blogs: 2, youtube: 2, negative: 0, hidden: false },
            { sprint: 268, total: 48, social: 1, blogs: 13, youtube: 1, negative: 0, hidden: false },
            { sprint: 269, total: 52, social: 7, blogs: 5, youtube: 0, negative: 1, hidden: false },
            { sprint: 270, total: 44, social: 3, blogs: 2, youtube: 1, negative: 0, hidden: false },
            { sprint: 271, total: 42, social: 0, blogs: 5, youtube: 0, negative: 0, hidden: false },
          ],
        },
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 268, position: 39, hidden: false },
            { sprint: 269, position: 39, hidden: false },
            { sprint: 270, position: 39, hidden: false },
            { sprint: 271, position: 39, hidden: false },
            { sprint: 272, position: 39, hidden: false },
          ],
        },
      },
      {
        ...
        data: {
          ...
          rows: [
            ...
            { sprint: 268, total: 98, direct: 71, hidden: false },
            { sprint: 269, total: 109, direct: 75, hidden: false },
            { sprint: 270, total: 154, direct: 109, hidden: false },
            { sprint: 271, total: 203, direct: 79, hidden: false },
          ],
        },
      },
      {
        ...
        data: {
          ...
          liveChat: {
            ...
            rows: [
              ...
              { sprint: 269, conversations: 1, avgAssignment: "22s", csat: "-", badRating: "-", hidden: false },
              { sprint: 270, conversations: 3, avgAssignment: "8m 9s", csat: "-", badRating: "-", hidden: false },
              { sprint: 271, conversations: "-", avgAssignment: "-", csat: "-", badRating: "-", hidden: false },
              { sprint: 272, conversations: "-", avgAssignment: "-", csat: "-", badRating: "-", hidden: false },
            ],
          },
        },
      },
        ...
        data: {
          ...
          q3Performance: {
            ...
            rows: [
              ...
              { quarter: "Sprint 268", target: 7, achieved: 3, percentage: "43%", hidden: false },
              { quarter: "Sprint 269", target: 7, achieved: 1, percentage: "14%", hidden: false },
              { quarter: "Sprint 270", target: 7, achieved: 0, percentage: "0%", hidden: false },
              { quarter: "Sprint 271", target: 7, achieved: 8, percentage: "114%", hidden: false },
            ],
          },
        },
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 268, signups: 23, paid: 5, percentage: 19, shortfall: 121, hidden: false },
            { sprint: 269, signups: 32, paid: 10, percentage: 37, shortfall: 138, hidden: false },
            { sprint: 270, signups: 37, paid: 8, percentage: 30, shortfall: 157, hidden: false },
            { sprint: 271, signups: 37, paid: 20, percentage: 70, shortfall: 164, hidden: false },
            { sprint: 272, signups: 33, paid: 9, percentage: 33, shortfall: 182, hidden: false },
          ],
      ...
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 262, totalAccounts: 135, paidTrials: 134, payingUsers: 37, hidden: false },
            { sprint: 263, totalAccounts: 181, paidTrials: 180, payingUsers: 38, hidden: false },
            { sprint: 264, totalAccounts: 139, paidTrials: 135, payingUsers: 26, hidden: false },
            { sprint: 265, totalAccounts: 156, paidTrials: 146, payingUsers: 32, hidden: false },
            { sprint: 266, totalAccounts: 131, paidTrials: 41, payingUsers: 35, hidden: false },
            { sprint: 267, totalAccounts: 141, paidTrials: 46, payingUsers: 40, hidden: false },
            { sprint: 268, totalAccounts: 147, paidTrials: 35, payingUsers: 29, hidden: false },
            { sprint: 269, totalAccounts: 135, paidTrials: 44, payingUsers: 39, hidden: false },
            { sprint: 270, totalAccounts: 203, paidTrials: 38, payingUsers: 24, hidden: false },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          rows: [
            ...
            { sprint: 266, totalAccounts: 1, paidTrials: 0, payingUsers: 2, hidden: false },
            { sprint: 267, totalAccounts: 11, paidTrials: 2, payingUsers: 2, hidden: false },
            { sprint: 268, totalAccounts: 11, paidTrials: 6, payingUsers: 5, hidden: false },
            { sprint: 269, totalAccounts: 14, paidTrials: 6, payingUsers: 6, hidden: false },
            { sprint: 270, totalAccounts: 13, paidTrials: 4, payingUsers: 2, hidden: false },
          ],
        },
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 263, formFills: 17, demos: 2, signups: 0, paying: 0, hidden: false },
            { sprint: 264, formFills: 18, demos: 0, signups: 1, paying: 0, hidden: false },
            ...
            { sprint: 268, formFills: 15, demos: 0, signups: 0, paying: 0, hidden: false },
            { sprint: 269, formFills: 14, demos: 0, signups: 1, paying: 0, hidden: false },
            { sprint: 270, formFills: 18, demos: 0, signups: 1, paying: 0, hidden: false },
            { sprint: 271, formFills: 14, demos: 0, signups: 1, paying: 0, hidden: false },
            { sprint: 272, formFills: 15, demos: 0, signups: 2, paying: 0, hidden: false },
          ],
        },
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 268, trials: 11, conversions: 42, hidden: false },
            { sprint: 269, trials: 5, conversions: 60, hidden: false },
            { sprint: 270, trials: 5, conversions: 58, hidden: false },
            { sprint: 271, trials: 17, conversions: 30, hidden: false },
            { sprint: 272, trials: 17, conversions: 26, hidden: false },
          ],
      ...
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 268, freeSignups: 85, paid: 8, hidden: false },
            { sprint: 269, freeSignups: 100, paid: 8, hidden: false },
            { sprint: 270, freeSignups: 79, paid: 5, hidden: false },
            { sprint: 271, freeSignups: 64, paid: 10, hidden: false },
            { sprint: 272, freeSignups: 88, paid: 16, hidden: false },
          ],
      ...
      },
      {
        ...
        data: {
          ...
          rows: [
            { sprint: 268, trials: 0, referrals: 0, hidden: false },
            { sprint: 269, trials: 1, referrals: 6, hidden: false },
            { sprint: 270, trials: 0, referrals: 1, hidden: false },
            { sprint: 271, trials: 3, referrals: 1, hidden: false },
            { sprint: 272, trials: 5, referrals: 2, hidden: false },
          ],
      ...
      },
      {
        ...
        data: {
          rows: [
            { channel: "Direct (new subscription)", totalTarget: 11009, targetAsOnDate: 8616, actual: 5314, percentage: 62, hidden: false },
            { channel: "Agency (new subscription)", totalTarget: 315, targetAsOnDate: 247, actual: 88, percentage: 36, hidden: false },
            { channel: "Affiliate (paid signups)", totalTarget: 1000, targetAsOnDate: 783, actual: 387, percentage: 49, hidden: false },
            { channel: "Ads", totalTarget: 800, targetAsOnDate: 626, actual: 370, percentage: 59, hidden: false },
          ],
        },
      },
    ],
    ...
    switch (slide.type) {
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
              <div>
                ...
                >
                  <h3 style={{ fontSize: "20px", fontWeight: "600", color: "#2DAD70" }}>↑ Improved</h3>
                  {isEditMode && (
                    <button
                      onClick={() => {
                        const newSlides = sprintData.slides.map((s) => {
              ...
              <div>
                ...
                >
                  <h3 style={{ fontSize: "20px", fontWeight: "600", color: "#DC2143" }}>↓ Declined</h3>
                  {isEditMode && (
                    <button
                      onClick={() => {
                        const newSlides = sprintData.slides.map((s) => {
      ...
      case "pluginRanking":
        return (
          <div>
            ...
            >
              <strong style={{ color: "#212121", fontSize: "18px" }}>QUARTER TARGET: </strong>
              {isEditMode ? (
                <input
                  type="number"
                ...
                <span style={{ fontWeight: "600", color: "#1863DC", fontSize: "20px" }}>
      ...
      case "supportData":
        return (
          <div>
            <div style={{ marginBottom: "32px" }}>
              <h3 style={{ fontSize: "20px", fontWeight: "600", marginBottom: "16px", color: "#212121" }}>Tickets</h3>
              <EditableTable slide={{ ...slide, id: slide.id, data: slide.data.tickets, type: slide.type }} />
            </div>
            <div>
              <h3 style={{ fontSize: "20px", fontWeight: "600", marginBottom: "16px", color: "#212121" }}>Live Chat</h3>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                {["impressions", "clicks", "CTR", "conversions"].map((metric) => {
                  ...
                  return (
                    ...
                    >
                      <span style={{ fontSize: "19px", fontWeight: "600", color: "#212121" }}>{label}</span>
        ...
        return (
          <div>
            <div style={{ marginBottom: "20px" }}>
              ...
              >
                <h3 style={{ fontSize: "20px", fontWeight: "600", color: "#212121" }}>Quarter Stats</h3>
                {isEditMode && (
          ...
          <div>
            ...
            >
              ...
              {isEditMode ? (
                ...
                <span style={{ fontWeight: "600", color: "#1863DC", fontSize: "20px" }}>{slide.data.target}</span>
              )}
            </div>
            <EditableTable slide={slide} />
            {slide.data.total && !slide.data.hideQtdStats && (
              <div style={{ marginTop: "20px" }}>
                ...
                >
                  <h3 style={{ fontSize: "20px", fontWeight: "600", color: "#212121" }}>QTD Stats</h3>
                  {isEditMode && (
                    <div style={{ display: "flex", gap: "8px" }}>
        ...
        return (
          <div>
            {slide.data.target !== undefined && (
              ...
              >
                <strong style={{ color: "#212121", fontSize: "18px" }}>TARGET VS CURRENT - PAID PLANS: </strong>
                {isEditMode ? (
                  <>
                    <input
                      type="number"
            ...
            <div style={{ marginTop: "20px" }}>
              <div
                style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}
              >
                <h3 style={{ fontSize: "20px", fontWeight: "600", color: "#212121" }}>App Lifetime Stats</h3>
                {isEditMode && (
                  <div style={{ display: "flex", gap: "8px" }}>
